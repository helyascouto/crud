...
namespace CadastroProdutos.Class
{
    public class Funcionarios
    {
        ...
        SqlConnection conexao = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\BUTFIRE\Desktop\CadastroPessoas\CadastroPessoas\BD\DB_SistemaCadastro.mdf;Integrated Security=True;Connect Timeout=30");
        SqlDataAdapter da;
        String comandoSql;
        DataSet ds;
